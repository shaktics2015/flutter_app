...
class LoginScreenState extends State<LoginScreen> with CommonLoginMixin{   
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      UserService().saveToSharedPreferences('email',user.email, "STRING",preferences:_prefs); 
        UserService().saveToSharedPreferences('login_type','DIRECT', "STRING", preferences: _prefs);
        ...
        body: new SingleChildScrollView(
            ...
            child: new Container(
              ...
              child: new Column(
                ...
                socialButton("Google", Action.google, context, (isSubmitting) {
                  if (mounted) {
                    setState(() {
                      // disable btn
                    });
