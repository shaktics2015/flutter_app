class Product {
  ...
  Product({ this.price, this.rating, this.title, this.writer, this.id, this.image, 
      this.pages, this.documentID});

  factory Product.fromJson(Map<String, dynamic> json) {
    return new Product(price:json['price'], rating: json['rating'], title:json['title'], writer:json['writer'], id:json['id'],
       image: json['image'], pages: json['pages'], documentID: json['documentID']);
  }
